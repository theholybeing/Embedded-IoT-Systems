...
#define BLYNK_TEMPLATE_ID "TMPL6nkP5vb1-"
#define BLYNK_TEMPLATE_NAME "DHTbyUmer"
#define BLYNK_AUTH_TOKEN    "rSBhTnqQkutn5mq1CVSEgIDQvN77udnm"  // <-- from Blynk device_hLmtVUUWlhtBanXKpviBJt0D_zIBJsA
...
void setup() {
  ...
  timer.setInterval(1000L, periodicSend);
}
